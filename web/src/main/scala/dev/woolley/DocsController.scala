...
import dev.woolley.buildinfo.BuildInfo
...
/*
 * From https://github.com/jakehschwartz/finatra-swagger/blob/master/src/main/scala/com/jakehschwartz/finatra/swagger/DocsController.scala
 */
@Singleton
class DocsController @Inject()(swagger: Swagger,
                               endpoint: String) extends Controller {
